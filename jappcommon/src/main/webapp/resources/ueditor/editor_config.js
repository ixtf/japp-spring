...
window.UEDITOR_HOME_URL = "/personalevaluation/resources/ueditor/";
...
//URL = "http://192.168.17.117:8080/personalevaluation/resources/ueditor/"
/**
...
,toolbars:[["FullScreen","Undo","Redo","PastePlain","|","Bold","Italic","Underline","StrikeThrough","FontFamily","FontSize","ForeColor","InsertOrderedList","InsertUnorderedList","|","SelectAll","ClearDoc","SearchReplace","Date","Time","Link","Unlink","Horizontal","Spechars","BlockQuote","touppercase","tolowercase","Superscript","Subscript","Print","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells","InsertCol","InsertRow","DeleteCol","DeleteRow","InsertParagraphBeforeTable"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'fullscreen':'','undo':'','redo':'','pasteplain':'','|':'','bold':'','italic':'','underline':'','strikethrough':'','fontfamily':'','fontsize':'','forecolor':'','insertorderedlist':'','insertunorderedlist':'','|':'','selectall':'','cleardoc':'','searchreplace':'','date':'','time':'','link':'','unlink':'','horizontal':'','spechars':'','blockquote':'','touppercase':'','tolowercase':'','superscript':'','subscript':'','print':'','inserttable':'','deletetable':'','mergeright':'','mergedown':'','splittorows':'','splittocols':'','splittocells':'','mergecells':'','insertcol':'','insertrow':'','deletecol':'','deleterow':'','insertparagraphbeforetable':''}
