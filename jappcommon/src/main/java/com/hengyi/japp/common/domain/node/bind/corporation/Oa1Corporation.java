...
@NodeEntity
public class Oa1Corporation extends AbstractBindCorporation {
	@NotNull
	@NotEmpty
	@Indexed(unique = true)
	protected String id;

	public Oa1Corporation() {
		super();
	}

	public Oa1Corporation(String id, String name) {
		super(id, name);
	}
	...
	public BindCorporationType getBindCorporationType() {
		return BindCorporationType.OA1;
	}
}
