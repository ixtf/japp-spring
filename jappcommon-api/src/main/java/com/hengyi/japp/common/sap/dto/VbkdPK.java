...
@Embeddable
@XmlRootElement(namespace = Constant.NAME_SPACE, name = "VbkdPK")
public class VbkdPK implements ValueObject<VbkdPK> {
	private static final long serialVersionUID = -145343584818189364L;
	...
	public VbkdPK(String vbeln, String posnr) {
		super();
		this.vbeln = vbeln;
		this.posnr = posnr;
	}
	...
	@Override
	public boolean sameValueAs(VbkdPK other) {
		return other != null
