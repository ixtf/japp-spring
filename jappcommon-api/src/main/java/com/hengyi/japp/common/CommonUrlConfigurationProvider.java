...
public class CommonUrlConfigurationProvider extends HttpConfigurationProvider {
	...
	protected void urlService(ConfigurationBuilder builder,
			AbstractUrlService... urlServices) {
		for (AbstractUrlService urlService : urlServices)
			urlService(builder, urlService);
	}

	protected void urlService(ConfigurationBuilder builder,
			AbstractUrlService urlService) {
		builder.addRule(
