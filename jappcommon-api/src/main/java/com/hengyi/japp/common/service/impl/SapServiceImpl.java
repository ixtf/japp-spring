...
public abstract class SapServiceImpl implements SapService {
	...
	public static final String POOL_PRO = DestinationType.PRO.name();
	public static final String POOL_EQ = DestinationType.EQ.name();
	public static final String POOL_DEV = DestinationType.DEV.name();
	@Resource
