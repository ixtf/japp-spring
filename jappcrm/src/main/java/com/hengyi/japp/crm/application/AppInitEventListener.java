...
import static com.hengyi.japp.crm.Constant.SapFunction.INIT_KNA1;
import static com.hengyi.japp.crm.Constant.SapFunction.INIT_LFA1;
...
public class AppInitEventListener implements ApplicationListener<AppInitEvent> {
	...
	private void initIndicator() throws Exception {
		...
		crmField = new CrmField("registerCapital");
		crmFileds.add(crmField);
		...
		crmField = new CrmField(CrmFieldType.STORAGE, "capacity");
		crmFileds.add(crmField);
		indicators.add(new StorageIndicator("仓储容量", 0.08, crmField));
		...
		crmFileds.add(new CrmField("corporationTypes", "corporationType"));
