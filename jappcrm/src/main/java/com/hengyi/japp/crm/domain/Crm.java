...
public abstract class Crm extends Modifiable {
	...
	@RelatedTo(type = CRM_TYPE, elementClass = CorporationType.class)
	@Fetch
	protected Set<CorporationType> crmTypes;
	...
	public Iterable<CorporationType> getCrmTypes() {
		if (crmTypes == null)
	...
	public void setCrmTypes(Iterable<CorporationType> crmTypes) {
